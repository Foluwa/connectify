...
//CHANGE GROUP TYPE TO GROUP TAGS
    ...
    new Groups({
        ...
        new Groups({
        useremail: 'moronfoluwaakintola@gmail.com',
        groupname: 'Just-API Gitter',
        groupurl : 'https://gitter.im/just-api/Lobby',
        groupinfo:  'Just-API is a declarative, specification based test framework for REST, GraphQL (or any HTTP-based) APIs. Users can test APIs without writing code, but they can also tap into code when they want to.',
        grouptype :'[Programming, Backend, APIs]' ,
        groupplatform: 'Gitter' 
    }),
    new Groups({
        useremail: 'moronfoluwaakintola@gmail.com',
        groupname: 'Just-API Google Groups',
        groupurl : 'https://groups.google.com/forum/#!forum/just-api',
        groupinfo:'Just-API is a declarative, specification based test framework for REST, GraphQL (or any HTTP-based) APIs. Users can test APIs without writing code, but they can also tap into code when they want to.' ,
        grouptype :'[Programming, Backend, APIs]' ,
        groupplatform: 'Google-groups' 
    }),
    new Groups({
        useremail: 'moronfoluwaakintola@gmail.com',
